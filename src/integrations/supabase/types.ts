...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      increment_post_view:
        | { Args: { post_uuid: string }; Returns: undefined }
        | {
            Args: { post_uuid: string; session_uuid?: string }
            Returns: boolean
          }
      is_following: { Args: { target_user_id: string }; Returns: boolean }
      is_post_author: { Args: { post_uuid: string }; Returns: boolean }
    }
    Enums: {
      post_status: "draft" | "published"
      post_type: "article" | "poetry"
    }
    CompositeTypes: {
      [_ in never]: never
    }
